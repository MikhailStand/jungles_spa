...
const masters = [
  { name: 'Эка', origin: 'Премиум-мастер с Бали', image: './images/master-1.png', text: 'Бережно чувствует темперамент гостя и подбирает технику и силу воздействия под его состояние и пожелания. Особенно уверенно выполняет комплексные SPA-программы, в которых важны плавность, деликатность и глубокое расслабление.' },
  { name: 'Нан', origin: 'Премиум-мастер из Таиланда', image: './images/master-2.png', text: 'Мастер с 30-летним стажем и сильной, глубокой техникой. Тщательно прорабатывает тело и помогает снять накопившееся мышечное напряжение. Подойдёт гостям, которые предпочитают выразительное воздействие.' },
  { name: 'Аю', origin: 'Премиум-мастер с Бали', image: './images/master-3.png', text: 'Сочетает хваткую и мягкую манеру массажа, плавно меняя интенсивность во время сеанса. Специализируется на массажах и SPA-программах, создавая глубокое расслабление, ощущение лёгкости и спокойной перезагрузки.' },
  { name: 'Оксана', origin: 'Мастер с медицинским образованием', image: './images/master-4.jpg', text: 'Практикует расслабляющий массаж тела с маслами и сочетает несколько техник в одном сеансе. Также выполняет архитектурный и подтягивающий массаж лица, уделяя внимание тонусу и выразительности линий.' },
];
